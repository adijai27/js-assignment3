...
for (let i = 0; i < img_var.length; i++) {
    img_var[i].addEventListener("mouseover", active_class);
    // img_var[i].addEventListener("mouseout", deactive_class);
    img_var[i].addEventListener("click", rplace_img);
    console.log("DKJF");
}
